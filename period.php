    ...
    <div class="main-panel">
      ...
      <div class="container">
        <div class="page-inner">
                    ...
                    <table
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            <td><?php echo $i++; ?></td>
                            <td hidden><?php echo $data['pid'];  ?></td>
                            <td><?php echo $data['acdyear'];  ?></td>
                            <td><?php echo $data['semester'];  ?></td>
                            <td><?php echo $data['periodperday'];  ?></td>
                            <td><?php echo $data['subperweek'];  ?></td>
                            <td><?php echo $data['periodperday'] * 5;  ?></td>
                            <td>
                              <div class="form-button-action">
                                <a href="Period_Update.php?pid=<?= $data['pid']; ?>"
                                  type="button"
          ...
          <form id="deleteForm" method="post" action="Period_process.php" style="display:none;">
  ...
  <script>
    $(".delete-btn").click(function(e) {
      ...
      swal({
        ...
        if (Delete) {
          $('#pid').val(pid); // put dept_code into hidden form
  ...
  <?php if (isset($_GET['status'])): ?>
    <script>
      $(document).ready(function() {
        ...
        switch (status) {
          case 'success':
            content.message = 'Period added successfully!';
            content.title = "Success";
            break;
          case 'up_success':
            content.message = 'Period Updated Successfully!';
            content.title = "Success";
            break;
          case 'del_success':
            content.message = 'Period Deleted successfully!';
            content.title = "Success";
            break;
          case 'del_unsuccess':
            content.message = 'Period Deleted Unsuccessfully!';
