          ...
          <div class="page-inner">
            <div class="page-header">
              ...
              <ul class="breadcrumbs">
                ...
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="Add_Period.php">Add Period</a></li>
              </ul>
            </div>
                  ...
                  <div class="card">
                    <form action="Period_process.php" method="post">
                      ...
                      <div class="card-body">
                        ...
                        <!-- <div class="form-group">
                          <label for="defaultSelect">Class</label>
                          <select
                            class="form-select form-control"
                            id="defaultSelect"
                            name ="year_name"
                        ...
                        <div class="form-group">
                          ...
                          >
                            <option selected disabled> Period Per Day</option>
                        ...
                        <div class="form-group">
                          ...
                          <select
                            ...
                            name="subweek"
                          >
                            <option selected disabled>Subject Period Per Week</option>
    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        if (status === 'error') {
          ...
          content.message = 'Error: Period is already exist! ,Click to Check ';
