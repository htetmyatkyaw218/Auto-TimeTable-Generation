...
<body>
    ...
    <div class="main-panel">
      ...
      <div class="container">
        <div class="page-inner">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $data['dept_building'];  ?></td>
                            <td>
                              <div class="form-button-action">
                                <a href="Department_Update.php?dept_code=<?= $data['dept_code']; ?>"
                                  type="button"
          ...
          <form id="deleteForm" method="post" action="Department_process.php" style="display:none;">
  ...
  <script>
    $(".delete-btn").click(function(e) {
      var deptCode = $(this).attr('data-dept-code');
      swal({
        icon: null,
        ...
        if (Delete) {
          $('#dept_code').val(deptCode); // put dept_code into hidden form
  ...
  <?php if (isset($_GET['status'])): ?>
    <script>
      $(document).ready(function() {
        ...
        switch (status) {
          case 'success':
            content.message = 'Department added successfully!';
            content.title = "Success";
            break;
          case 'up_success':
            content.message = 'Department Updated Successfully!';
            content.title = "Success";
            break;
          case 'del_success':
            ...
            break;
          case 'del_unsuccess':
            content.message = 'Department Deleted Unsuccessfully!';
