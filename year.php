              ...
              <div class="col-md-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    ?> 
                          <tr>
                            <td hidden><?php echo $data['year_id'];  ?></td>
                            <td><?php echo $i++; ?></td>
                            ...
                            <td>
                              <div class="form-button-action">
                                <a href="Year_Update.php?year_id=<?= $data['year_id']; ?>"
                                  type="button"
...
<form id="deleteForm" method="post" action="Year_process.php" style="display:none;">
    ...
    <script src="assets/js/plugin/custom.js"></script>
        ...
        <script >
            ...
            var year_id = $(this).attr('data-dept-code');
            swal({
              icon: null,
              ...
              if (Delete) {
                 $('#year_id').val(year_id);  // put dept_code into hidden form
...
$(document).ready(function () {
    ...
    switch(status) {
        case 'success':
            content.message = 'Year added successfully!';
            content.title = "Success";
            break;
        case 'up_success':
            content.message = 'Year Updated Successfully!';
            content.title = "Success";
            break;
        case 'del_success':
            content.message = 'Year Deleted successfully!';
            content.title = "Success";
            content.icon = "fa fa-check-circle";
            state = "success";
            break;
        case 'del_unsuccess':
            content.message = 'Year Deleted Unsuccessfully!';
