          ...
          <div class="page-inner">
            <div class="page-header">
              ...
              <ul class="breadcrumbs">
                ...
                <li class="nav-item"><a href="section.php">Setting</a></li>
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="section.php">Section</a></li>
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="Add_Section.php">Add Section</a></li>
              </ul>
            </div>
                  ...
                  <div class="card">
                    <form action="Section_process.php" method="post">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="section_name" class="form-control" placeholder="A" required />
                            </div>
                      ...
                      <div class="card-action d-flex gap-2 flex-wrap">
                        ...
                        <button type="button" class="btn btn-outline-danger btn-round"  onclick="window.location.href='section.php'"><i class="fa fa-times me-1"></i>Cancel</button>
                      </div>
                    </form>
                  </div>
                </div>
