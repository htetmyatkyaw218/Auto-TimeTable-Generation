          ...
          <div class="page-inner">
            <div class="page-header">
              ...
              <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                  <a href="Add_Year.php">Add Year</a>
                </li>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  ...
                  <button type="button" class="btn btn-outline-danger btn-round"  onclick="window.location.href='year.php'"><i class="fa fa-times me-1"></i>Cancel</button>
