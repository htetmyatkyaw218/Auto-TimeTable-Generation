...
<body>
    ...
    <div class="main-panel">
      ...
      <div class="container">
        <div class="page-inner">
                    ...
                    <table
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            <td><?php echo $i++; ?></td>
                            <td hidden><?php echo $data['teacher_id'];  ?></td>
                            ...
                            <td>
                              <div class="form-button-action">
                                <a href="Teacher_Update.php?teacher_id=<?= $data['teacher_id']; ?>"
                                  type="button"
          ...
          <form id="deleteForm" method="post" action="Teacher_process.php" style="display:none;">
  ...
  <script>
    $(".delete-btn").click(function(e) {
      var teacher_id = $(this).attr('data-rank');
      swal({
        icon: null,
        ...
        if (Delete) {
          $('#teacher_id').val(teacher_id); // put dept_code into hidden form
