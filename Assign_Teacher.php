        ...
        <div class="page-inner">
          <div class="page-header">
            ...
            <ul class="breadcrumbs">
              ...
              <li class="nav-item">
                <a href="Assign_Teacher.php">Add Data</a>
              </li>
              <li class="separator">
                <i class="icon-arrow-right"></i>
              </li>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="d-flex align-items-center">
                    <h4 class="card-title">Assign Teacher Details</h4>
                    <a href="Add_Assign_Teacher.php"
                  ...
                  <div class="table-responsive">
                    <table
                      ...
                      <tbody>
                        ...
                        $query = "SELECT teaches.teaches_id,teaches.year_id,teaches.section_id,teaches.teacher_name,teaches.teaches_id,teaches.dept_code,subject.scode,year.year_name,year.semester,section.section_name FROM  teaches JOIN year ON year.year_id = teaches.year_id JOIN subject ON subject.sub_id = teaches.sub_id JOIN section ON section.section_id = teaches.section_id ORDER BY teaches.year_id , teaches.section_id";
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="form-button-action">
                                <a href="Assign_Teacher_Update.php?teaches_id=<?= $data['teaches_id']; ?>"
                                  type="button"
          ...
          <form id="deleteForm" method="post" action="Assign_Teacher_process.php" style="display:none;">
  ...
  <script>
    $(".delete-btn").click(function(e) {
      ...
      swal({
        ...
        text: "This will remove all assigned teachers for this class. Continue?",
        buttons: {
          cancel: {
            visible: true,
            text: "Keep it",
  ...
  <?php if (isset($_GET['status'])): ?>
    <script>
      $(document).ready(function() {
        ...
        // Set default icon
        // content.icon = (style === "withicon") ? "fa fa-bell" : "none";
        content.icon = "fa fa-bell";

        // Define messages based on status
        switch (status) {
          case 'success':
            content.message = 'Teacher Assign successfully!';
            content.title = "Success";
            break;
          case 'up_success':
            content.message = 'Teacher Assign Updated Successfully!';
            content.title = "Success";
            break;
          case 'del_success':
            content.message = 'Assign Teacher  Remove successfully!';
            content.title = "Success";
            break;
          case 'del_unsuccess':
            content.message = 'Teacher Assign Remove Unsuccessfully!';
