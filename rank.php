    ...
    <div class="main-panel">
      ...
      <div class="container">
        <div class="page-inner">
              ...
              <div class="card">
                <div class="card-header">
                  <div class="d-flex align-items-center">
                    <h4 class="card-title">Rank Details</h4>
                    <a href="Add_Rank.php"
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $data['rank_code'];  ?></td>
                            <td>
                              <div class="form-button-action">
                                <a href="Rank_Update.php?rank=<?= $data['rank']; ?>"
                                  type="button"
          ...
          <form id="deleteForm" method="post" action="Rank_process.php" style="display:none;">
  ...
  <script>
    $(".delete-btn").click(function(e) {
      ...
      swal({
        ...
        text: "This action will permanently remove the rank. Continue?",
        buttons: {
          cancel: {
            text: "Keep it",
            visible: true,
        ...
        if (willDelete) {
          $('#rank').val(rank); // put dept_code into hidden form
  ...
  <?php if (isset($_GET['status'])): ?>
    <script>
      $(document).ready(function() {
        ...
        switch (status) {
          case 'success':
            content.message = 'Rank added successfully!';
            content.title = "Success";
            break;
          case 'up_success':
            content.message = 'Rank Updated Successfully!';
            content.title = "Success";
            break;
          case 'del_success':
            content.message = 'Rank Deleted successfully!';
            content.title = "Success";
            content.icon = "fa fa-check-circle";
            state = "success";
            break;
          case 'del_unsuccess':
            content.message = 'Rank Deleted Unsuccessfully!';
