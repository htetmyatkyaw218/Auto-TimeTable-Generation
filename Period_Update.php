          ...
          <div class="page-inner">
            <div class="page-header">
              ...
              <ul class="breadcrumbs">
                ...
                <li class="nav-item"><a href="period.php">Setting</a></li>
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="period.php">Add Data</a></li>
                 <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="period.php">Period</a></li>
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="Period_Update.php">Update Period</a></li>
              </ul>
            </div>
            ...
            <div class="page-category">
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                    <form action="Period_process.php" method="post">
                      <div class="card-header">
                        <div class="card-title">Update Period</div>
                      </div>
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <select
                            ...
                            name ="semester"
                            required>
                            <option selected value="<?php echo $data['semester'];?>"><?php echo $data['semester'];?></option>
                              <?php
                                 if(!$result1){
                                 die("Connection failed: " . mysqli_connect_error());
                                 }
                        ...
                        <div class="form-group">
                          ...
                          >
                            <option selected value="<?php echo $data['periodperday'];?>"> <?php echo $data['periodperday'];?></option>
                        ...
                        <div class="form-group">
                          <label >Each Subject Period Per Week <span style="color: red;  font-size: 1.2em;">*</span></label>
                          <select
                            class="form-select form-control"
                            id="subjectPeriodPerWeek"
                            name="subweek"
                          >
                            <option selected value="<?php echo $data['subperweek'];?>"><?php echo $data['subperweek'];?></option>
                      ...
                      <div class="card-action d-flex gap-2 flex-wrap">
                        ...
                        <button type="button" class="btn btn-outline-danger btn-round"  onclick="window.location.href='period.php'"><i class="fa fa-times me-1"></i>Cancel</button>
                      </div>
                    </form>
                  </div>
                </div>
...
function updateSubjectPeriodOptions() {
  ...
  subjectSelect.innerHTML = '<option selected disabled value="<?php echo $data['subperweek'];?>"><?php echo $data['subperweek'];?></option>';

  if (!isNaN(perDay)) {
    const totalPeriods = perDay * 5;
    const totalSubjects = Math.floor(totalPeriods / 6); // as per your logic
    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        if (status === 'error') {
          ...
          content.message = 'Error: Please! Choose One More Time Period Per Day And Period Per Week Together ! ';
          content.title = "Warning";
          content.icon = "fa fa-exclamation-triangle";
          var state = "warning";

         // content.url = "period.php";
