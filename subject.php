...
<body>
    ...
    <div class="main-panel">
      ...
      <div class="container">
        <div class="page-inner">
                  ...
                  <div class="table-responsive">
                    <table
                      ...
                      <tbody>
                        ...
                        $query = "SELECT subject.sub_id, subject.scode, subject.sname, year.acdyear, year.semester, year.year_name, subject.pre_requisite, subject.credit_unit, subject.type, subject.dept_code, subject.degree_type, subject.year_id
                      FROM subject 
                      INNER JOIN year ON subject.year_id = year.year_id 
                      ORDER BY subject.sub_id ASC";
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?= $data['credit_unit']; ?></td>
                            <td><?= $data['type']; ?></td>
                            <td><?= $data['dept_code']; ?></td>
                            <td><?= $data['degree_type']; ?></td>
                            <td>
                              <div class="form-button-action">
                                <a href="Subject_Update.php?sub_id=<?= $data['sub_id']; ?>&year_id=<?= $data['year_id']; ?>"
                                  type="button"
          ...
          <form id="deleteForm" method="post" action="Subject_process.php" style="display:none;">
  ...
  <script>
    $(".delete-btn").click(function(e) {
      var sub_id = $(this).attr('data-rank');
      swal({
        icon: null,
        ...
        if (Delete) {
          $('#sub_id').val(sub_id); // put dept_code into hidden form
      ...
      $(document).ready(function() {
        ...
        switch (status) {
          case 'success':
            ...
            break;
          case 'up_success':
            content.message = 'Teacher Updated Successfully!';
            content.title = "Success";
            break;
          case 'del_success':
            content.message = 'Teacher Deleted successfully!';
            content.title = "Success";
            break;
          case 'del_unsuccess':
            content.message = 'Teacher Deleted Unsuccessfully!';
