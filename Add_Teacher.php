                      ...
                      <div class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <input
                            ...
                            name="email"
                            class="form-control "
                            placeholder="moemoesan@ucspathein.edu.mm"
                        ...
                        <div class="form-group">
                          <label>Address</label>
                          <textarea class="form-control" required placeholder="Pathein" name="address" rows="4" cols="50"></textarea>
                        </div>
